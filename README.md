# Angular Questions & Answer For interview
Angular Questions &amp; Answers For Interview 

# Angular Interview Questions & Answers

> Click :star:if you like the project. Pull Request are gently appreciated in *improvements branch* . Follow me for technical updates.
...
3. ### What is TypeScript?
    ...
    ```typescript
    function greetingMessage(person: string) {
        return "Hello, " + person;
    }

    let user = "Hardik";

    document.body.innerHTML = greetingMessage(user);
    ```
    The greetingMessage method allows only string type as argument.
